        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Exercise = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TypeItems_Classes_ClassId",
                        column: x => x.ClassId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plans_PaymentMethods_PaymentMethodId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestockPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemsForExercise", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemsForExercise_Items_ItemId",
                        column: x => x.ItemId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemForExerciseId = table.Column<int>(type: "int", nullable: false),
                    IncidentPriority = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncidentItems", x => new { x.IncidentId, x.ItemForExerciseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IncidentItems_ItemsForExercise_ItemForExerciseId",
                        column: x => x.ItemForExerciseId,
                        principalTable: "ItemsForExercise",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncidentItems_ItemForExerciseId",
                table: "IncidentItems",
                column: "ItemForExerciseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemsForExercise_ItemId",
                table: "ItemsForExercise",
                column: "ItemId");
