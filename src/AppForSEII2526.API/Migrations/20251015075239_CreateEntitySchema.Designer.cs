...
namespace AppForSEII2526.API.Migrations
{
    ...
    [Migration("20251015075239_CreateEntitySchema")]
    partial class CreateEntitySchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppForSEII2526.API.Models.IncidentItem", b =>
                {
                    ...
                    b.Property<int>("ItemForExerciseId")
                        .HasColumnType("int");

                    b.Property<int>("IncidentPriority")
                        .HasColumnType("int");

                    b.HasKey("IncidentId", "ItemForExerciseId");
            ...
            modelBuilder.Entity("AppForSEII2526.API.Models.IncidentItem", b =>
                {
                    ...
                    b.HasOne("AppForSEII2526.API.Models.ItemForExercise", "ItemForExercise")
                        .WithMany("IncidentItems")
                        .HasForeignKey("ItemForExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
